...
class Chart : public Market {
 ...
 public:
   ...
   */
  double GetBarRangeSize(uint _bar) { return (Chart::GetHigh(_bar) - Chart::GetLow(_bar)) / Market::GetPointsPerPip(); }
   ...
   */
  double GetPeriodSeconds() { return ::PeriodSeconds(cparams.tf); }

  /**
   * Returns number of minutes in a period.
   */
  double GetPeriodMinutes() { return Chart::GetPeriodSeconds() * 60; }

  /**
   * Returns number of hours in a period.
   */
  double GetPeriodHours() { return Chart::GetPeriodSeconds() * 60 * 60; }
