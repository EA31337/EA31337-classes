...
public:
    ...
    static string GetErrorText(int code) {
      ...
      switch (code) {
          ...
          case  136: text = "Off quotes."; #ifdef __invalid__ ExpertRemove(); #endif break;
          case  137: text = "Broker is busy (never returned error)."; break;
          case  138: text = "Requote."; #ifdef __invalid__ ExpertRemove(); #endif break;
          case  139: text = "Order is locked."; break;
          case  140: text = "Long positions only allowed."; break;
          case  141: /* ERR_TOO_MANY_REQUESTS */ text = "Too many requests."; #ifdef __invalid__ ExpertRemove(); #endif break;
