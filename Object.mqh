...
class Object : public Dynamic {
 ...
 public:
  ...
  void *Get() { return IsValid(this.obj) ? this.obj : NULL; }

  /**
   * Check whether pointer is valid.
   * @docs: https://docs.mql4.com/constants/namedconstants/enum_pointer_type
   */
  static bool IsValid(void *_obj) { return CheckPointer(_obj) != POINTER_INVALID; }
  bool IsValid() { return IsValid(this.obj); }

  /**
   * Check whether pointer is dynamic.
   * @docs: https://docs.mql4.com/constants/namedconstants/enum_pointer_type
   */
  static bool IsDynamic(void *_obj) { return CheckPointer(_obj) == POINTER_DYNAMIC; }
  bool IsDynamic() { return IsDynamic(this.obj); }
