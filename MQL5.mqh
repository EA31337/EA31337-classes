...
#define ERR_STRUCT_WITHOBJECTS_ORCLASS \
  4005  // The structure contains objects of strings and/or dynamic arrays and/or structure of such objects and/or
        // classes.
#define ERR_INVALID_ARRAY 4006  // Array of a wrong type, wrong size, or a damaged object of a dynamic array.
#define ERR_ARRAY_RESIZE_ERROR \
...
#define ERR_NOTIFICATION_WRONG_PARAMETER \
  4516  // Invalid parameter for sending a notification - an empty string or NULL has been passed to the
        // SendNotification() function.
#define ERR_NOTIFICATION_WRONG_SETTINGS \
...
#define ERR_CANNOT_CLEAN_DIRECTORY \
...
#define ERR_FILE_ENDOFFILE \
  5027  // Unable to read the next piece of data from a CSV file (FileReadString, FileReadNumber, FileReadDatetime,
        // FileReadBool), since the end of file is reached.
// String Casting.
...
#define ERR_INCOMPATIBLE_ARRAYS \
  5050  // Copying incompatible arrays. String array can be copied only to a string array, and a numeric array - in
        // numeric array only.
#endif
...
// Enums.
  ...
  enum ENUM_ORDER_TYPE_FILLING {
    ...
    ORDER_FILLING_RETURN  // In case of partial filling a market or limit order with remaining volume is not canceled
  ...
  struct MqlTradeResult {
    ...
    string
        comment;  // Broker comment to operation (by default it is filled by description of trade server return code).
