...
enum ENUM_BAR_PATTERN {
  ...
  BAR_TYPE_CLOSE_GT_WEIGHTED = 1 << 12,  // Close price is above the weighted price (OH2C/4)
  ...
  BAR_TYPE_CLOSE_LT_WEIGHTED = 1 << 17,  // Close price is lower the weighted price (OH2C/4)
