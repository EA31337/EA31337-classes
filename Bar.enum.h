...
enum ENUM_BAR_PATTERN {
  ...
  BAR_TYPE_BODY_GT_PP_WOODIE = 1 << 6,    // Body is above the Woodie pivot price (OH2C/4)
  BAR_TYPE_BODY_GT_WICKS = 1 << 7,        // Body is greater than sum of wicks
  BAR_TYPE_CLOSE_GT_MED = 1 << 8,         // Close price is above the median price
  BAR_TYPE_CLOSE_GT_PP = 1 << 9,          // Close price is above the pivot price (HLC/3)
  BAR_TYPE_CLOSE_GT_PP_DM = 1 << 10,      // Close price is above the Tom DeMark pivot price
  BAR_TYPE_CLOSE_GT_PP_OPEN = 1 << 11,    // Close price is above the pivot price (OHLC/4)
  BAR_TYPE_CLOSE_GT_PP_WOODIE = 1 << 12,  // Close price is above the Woodie pivot price (OH2C/4)
  BAR_TYPE_CLOSE_GT_R1 = 1 << 13,         // Close price is above the R1 price (2PP-L)
  BAR_TYPE_CLOSE_LT_PP = 1 << 14,         // Close price is lower the pivot price (HLC/3)
  BAR_TYPE_CLOSE_LT_PP_DM = 1 << 15,      // Close price is lower the Tom DeMark pivot price
  BAR_TYPE_CLOSE_LT_PP_OPEN = 1 << 16,    // Close price is lower the pivot price (OHLC/4)
  BAR_TYPE_CLOSE_LT_PP_WOODIE = 1 << 17,  // Close price is lower the Woodie pivot price (OH2C/4)
