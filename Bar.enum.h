...
enum ENUM_BAR_PATTERN {
  ...
  BAR_TYPE_BODY_GT_MED = 1 << 3,          // Body is above the median price
  BAR_TYPE_BODY_GT_PP = 1 << 4,           // Body is above the pivot price (HLC/3)
  BAR_TYPE_BODY_GT_PP_DM = 1 << 5,        // Body is above the Tom DeMark pivot price
  BAR_TYPE_BODY_GT_PP_OPEN = 1 << 6,      // Body is above the pivot price (OHLC/4)
  BAR_TYPE_BODY_GT_PP_WOODIE = 1 << 7,    // Body is above the Woodie pivot price (OH2C/4)
  BAR_TYPE_BODY_GT_WICKS = 1 << 8,        // Body is greater than sum of wicks
  BAR_TYPE_CLOSE_GT_MED = 1 << 9,         // Close price is above the median price
  BAR_TYPE_CLOSE_GT_PP = 1 << 10,         // Close price is above the pivot price (HLC/3)
  BAR_TYPE_CLOSE_GT_PP_DM = 1 << 11,      // Close price is above the Tom DeMark pivot price
  BAR_TYPE_CLOSE_GT_PP_OPEN = 1 << 12,    // Close price is above the pivot price (OHLC/4)
  BAR_TYPE_CLOSE_GT_PP_WOODIE = 1 << 13,  // Close price is above the Woodie pivot price (OH2C/4)
  BAR_TYPE_CLOSE_GT_R1 = 1 << 14,         // Close price is above the R1 price (2PP-L)
  ...
  BAR_TYPE_CLOSE_LT_S1 = 1 << 18,         // Close price is lower the S1 price (2PP-H)
  ...
  // BAR_TYPE_CANDLE_GT_1PC = 1 << 29,      // Candle size is greater than 1% of the price
