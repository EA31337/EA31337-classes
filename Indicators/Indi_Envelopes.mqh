...
class Indi_Envelopes : public Indicator<EnvelopesParams> {
 public:
  ...
  Indi_Envelopes(EnvelopesParams &_p, ENUM_TIMEFRAMES _tf) : Indicator(INDI_ENVELOPES, _tf) {}
    ...
    switch (iparams.idstype) {
      ...
      case IDATA_ICUSTOM:
        _value = iCustom(istate.handle, Get<string>(CHART_PARAM_SYMBOL), Get<ENUM_TIMEFRAMES>(CHART_PARAM_TF),
                         iparams.GetCustomIndicatorName(), /**/ GetMAPeriod(), GetMAMethod(), GetMAShift(),
                         GetAppliedPrice(), GetDeviation() /**/, _mode, _shift);
        break;
      case IDATA_INDICATOR:
        _value = Indi_Envelopes::iEnvelopesOnIndicator(
            GetCache(), indi_src, Get<string>(CHART_PARAM_SYMBOL), Get<ENUM_TIMEFRAMES>(CHART_PARAM_TF), GetMAPeriod(),
