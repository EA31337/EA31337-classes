...
struct EnvelopesParams : IndicatorParams {
  ...
  double deviation;
  // Struct constructors.
  void EnvelopesParams(int _ma_period = 13, int _ma_shift = 0, ENUM_MA_METHOD _ma_method = MODE_SMA, ENUM_APPLIED_PRICE _ap = PRICE_OPEN,
                       double _deviation = 2, int _shift = 0)
