...
class Indi_Pivot : public Indicator {
 ...
 public:
   ...
   * Class constructor.
   */
  Indi_Pivot(IndiPivotParams &_p, ENUM_TIMEFRAMES _tf = PERIOD_CURRENT) : Indicator((IndicatorParams)_p) {
    params = _p;
  };
  Indi_Pivot(ENUM_TIMEFRAMES _tf = PERIOD_CURRENT) : Indicator(INDI_PIVOT, _tf){};
