...
#ifdef __MQL4__
        _value = Indi_MFI::iMFI(Get<string>(CHART_PARAM_SYMBOL), Get<ENUM_TIMEFRAMES>(CHART_PARAM_TF), GetPeriod(), _shift);
#else  // __MQL5__
        _value = Indi_MFI::iMFI(Get<string>(CHART_PARAM_SYMBOL), Get<ENUM_TIMEFRAMES>(CHART_PARAM_TF), GetPeriod(), GetAppliedVolume(), _shift, GetPointer(this));
#endif
        break;
      case IDATA_ICUSTOM:
