  ...
  double GetValue(int _shift = 0) {
    ...
    switch (params.idstype) {
      case IDATA_BUILTIN:
        ...
        _value = Indi_RSI::iRSI(Get<string>(CHART_PARAM_SYMBOL), Get<ENUM_TIMEFRAMES>(CHART_PARAM_TF), GetPeriod(), GetAppliedPrice(), _shift, GetPointer(this));
        break;
      case IDATA_ICUSTOM:
        istate.handle = istate.is_changed ? INVALID_HANDLE : istate.handle;
      ...
      case IDATA_INDICATOR:
        _value = Indi_RSI::iRSIOnIndicator(GetDataSource(), GetPointer(this), Get<string>(CHART_PARAM_SYMBOL), Get<ENUM_TIMEFRAMES>(CHART_PARAM_TF), GetPeriod(),
