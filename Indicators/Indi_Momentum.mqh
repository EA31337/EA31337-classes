...
class Indi_Momentum : public Indicator {
  ...
  public:
     ...
     * Class constructor.
     */
    void Indi_Momentum(Momentum_Params &_params, IndicatorParams &_iparams, ChartParams &_cparams)
    ...
    double GetValue(uint _shift = 0) {
      double _value = this.iMomentum(GetSymbol(), GetTf(), GetPeriod(), GetAppliedPrice(), _shift);
      CheckLastError();
      return _value;
    }
