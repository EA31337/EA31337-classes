...
#define iDeMarker4(symbol, tf, period, shift) \
        Indi_DeMarker::iDeMarker(symbol, tf, period, shift);
...
class Indi_DeMarker : public Indicator {
 public:
  ...
  double GetValue(int _shift = 0) {
    ...
    double _value = Indi_DeMarker::iDeMarker(GetSymbol(), GetTf(), GetPeriod(), _shift, GetPointer(this));
