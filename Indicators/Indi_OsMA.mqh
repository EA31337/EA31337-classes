...
class Indi_OsMA : public Indicator {
 ...
 public:
   ...
   * Class constructor.
   */
  Indi_OsMA(OsMAParams &_p, ENUM_TIMEFRAMES _tf = PERIOD_CURRENT) : Indicator((IndicatorParams)_p, _tf) { params = _p; }
  Indi_OsMA(ENUM_TIMEFRAMES _tf = PERIOD_CURRENT) : Indicator(INDI_OSMA, _tf) {}
