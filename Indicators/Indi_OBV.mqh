...
#ifdef __MQL4__
        _value = Indi_OBV::iOBV(Get<string>(CHART_PARAM_SYMBOL), Get<ENUM_TIMEFRAMES>(CHART_PARAM_TF), GetAppliedPrice(), _shift);
#else  // __MQL5__
        _value = Indi_OBV::iOBV(Get<string>(CHART_PARAM_SYMBOL), Get<ENUM_TIMEFRAMES>(CHART_PARAM_TF), GetAppliedVolume(), _shift, GetPointer(this));
#endif
        break;
      case IDATA_ICUSTOM:
