...
bool TestDateTimeConditions() {
  ...
  Condition *_is_new_hour = new Condition(COND_TYPE_DATETIME, DATETIME_COND_NEW_HOUR);
...
bool TestMarketConditions() {
  ...
  Condition *_peak_hours = new Condition(COND_TYPE_MARKET, MARKET_COND_IN_PEAK_HOURS);
