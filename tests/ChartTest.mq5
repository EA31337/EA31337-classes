...
int OnInit() {
  ...
  PrintFormat("Index to timeframe: %d=>%d, %d=>%d, %d=>%d, %d=>%d, %d=>%d, %d=>%d, %d=>%d, %d=>%d, %d=>%d", M1,
              Chart::IndexToTf(M1), M5, Chart::IndexToTf(M5), M15, Chart::IndexToTf(M15), M30, Chart::IndexToTf(M30),
              H1, Chart::IndexToTf(H1), H4, Chart::IndexToTf(H4), D1, Chart::IndexToTf(D1), W1, Chart::IndexToTf(W1),
              MN1, Chart::IndexToTf(MN1));
  ...
  PrintFormat("Chart to index: %d=>%d, %d=>%d, %d=>%d, %d=>%d, %d=>%d, %d=>%d, %d=>%d, %d=>%d, %d=>%d", PERIOD_M1,
              Chart::TfToIndex(PERIOD_M1), PERIOD_M5, Chart::TfToIndex(PERIOD_M5), PERIOD_M15,
              Chart::TfToIndex(PERIOD_M15), PERIOD_M30, Chart::TfToIndex(PERIOD_M30), PERIOD_H1,
              Chart::TfToIndex(PERIOD_H1), PERIOD_H4, Chart::TfToIndex(PERIOD_H4), PERIOD_D1,
              Chart::TfToIndex(PERIOD_D1), PERIOD_W1, Chart::TfToIndex(PERIOD_W1), PERIOD_MN1,
