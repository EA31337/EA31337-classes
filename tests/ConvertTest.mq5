...
int OnInit() {
  ...
  assertTrueOrFail(Convert::OrderTypeBuyOrSell(ORDER_TYPE_SELL) == ORDER_TYPE_SELL,
      "Invalid value for order type");
  assertTrueOrFail(Convert::OrderTypeBuyOrSell(ORDER_TYPE_SELL_LIMIT) == ORDER_TYPE_SELL,
      "Invalid value for order type");
  assertTrueOrFail(Convert::OrderTypeBuyOrSell(ORDER_TYPE_BUY) == ORDER_TYPE_BUY,
      "Invalid value for order type");
  assertTrueOrFail(Convert::OrderTypeBuyOrSell(ORDER_TYPE_BUY_LIMIT) == ORDER_TYPE_BUY,
      "Invalid value for order type");
  ...
  assertTrueOrFail(Convert::PointsToValue(1, 0, 4)  == 0.0001,
    "Invalid conversion of points to value");
  assertTrueOrFail(Convert::PointsToValue(10, 0, 4)  == 0.0010,
    "Invalid conversion of points to value");
  assertTrueOrFail(Convert::PointsToValue(1, 0, 5) == 0.00001,
    "Invalid conversion of points to value");
  assertTrueOrFail(Convert::PointsToValue(10, 0, 5) == 0.00010,
    "Invalid conversion of points to value");

  // Test GetPipDiff().
  assertTrueOrFail(Convert::GetValueDiffInPips(0.00010, 0.00020, True, 4) == 1,
    "Invalid result of diff value");
  assertTrueOrFail(Convert::GetValueDiffInPips(0.00020, 0.00010, False, 4) == 1,
    "Invalid result of diff value");
  assertTrueOrFail(Convert::GetValueDiffInPips(0.00020, 0.00010, False, 5) == 1,
    "Invalid result of diff value");
  assertTrueOrFail(Convert::GetValueDiffInPips(0.00400, 0.00200, False, 4) == 20,
    "Invalid result of diff value");
  assertTrueOrFail(Convert::GetValueDiffInPips(0.00400, 0.00200, False, 5) == 20,
    "Invalid result of diff value");
  ...
  assertTrueOrFail(Convert::ValueWithCurrency(1000, 2, "USD") == "$1000.00",
