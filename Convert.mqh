...
class Convert {
 public:
  ...
  static void StringToType(string value, int& out) { out = (int)StringToInteger(value); }

  static void StringToType(string value, long& out) { out = StringToInteger(value); }

  static void StringToType(string value, double& out) { out = StringToDouble(value); }

  static void StringToType(string value, string& out) { out = value; }
