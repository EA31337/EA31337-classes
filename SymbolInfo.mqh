...
enum ENUM_SYMBOL_SWAP_MODE {
  ...
  // Swaps are charged as the specified annual interest from the instrument price at calculation of swap (standard bank
  // year is 360 days).
  ...
  // Swaps are charged as the specified annual interest from the open price of position (standard bank year is 360
  // days).
  SYMBOL_SWAP_MODE_INTEREST_OPEN,
  // Swaps are charged by reopening positions. At the end of a trading day the position is closed. Next day it is
  // reopened by the close price +/- specified number of points (parameters SYMBOL_SWAP_LONG and SYMBOL_SWAP_SHORT).
  SYMBOL_SWAP_MODE_REOPEN_CURRENT,
  // Swaps are charged by reopening positions. At the end of a trading day the position is closed. Next day it is
  // reopened by the current Bid price +/- specified number of points (parameters SYMBOL_SWAP_LONG and
  // SYMBOL_SWAP_SHORT).
