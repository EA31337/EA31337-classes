...
class Trade {
 ...
 public:
   ...
   */
  bool OrderCalcMargin(ENUM_ORDER_TYPE _action,  // type of order
  ...
  static double GetMarginRequired(string _symbol, ENUM_ORDER_TYPE _cmd = ORDER_TYPE_BUY) {
    ...
    return _rates ? (MarginInit * SymbolInfo::GetAsk(_symbol) * SymbolInfo::GetTickValue(_symbol)) /
                        (SymbolInfo::GetTickValue(_symbol) * Account::AccountLeverage())
                  : 0;
#endif
  }
